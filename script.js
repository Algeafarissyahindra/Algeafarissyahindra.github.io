const CONFIG = {
    ...
    yesButton: "YES",
    noButton: "NO",
    noEscapeTexts: ["Eits, tra bisa😝", "Hehe, coba lagi 😜", "Yaudah deh, al anggap YES ya! 💕"],
    confirmTitle: "YEAAAY! umyyy Betul Mau 💗",
    confirmText: "Mulai dari sekarang umyyy resmi jadi…",
    badgeText: "My Valentine",
    nextButton: "Lanjut ",
    repeatButton: "Ulangi pertanyaan",
    flowerTitle: "Ini kado spesial buat umyyy ",
    takeBouquetButton: "Terima hadiahnya ",
    bouquetMessage: "Yeay! Udah jadi milik umyyy 💕",
    nextFlowerButton: "Next ",
    collageTitle: "My Beautiful You",
    collageSubtitle: "Al Senang deng Bahagia Skaliiii bisa samaa samaa deng umyyy terus. Happy Valentine, my favorite person. 💕",
    nextCollageButton: "Satu halaman lagi… ",
    finalTitle: "Happy Valentine, My Love 💞",
    finalMessage: `Makasih ya so hadir deng bikin al pe hari hari selalu rasa cukup. umyyy itu alasan kenapa al selalu bahagia. al sayanggggggg skaliii umyyy, Al selalu ada untuk umyyy. loveeee u sayanggg. Happy Valentine 💕`,
